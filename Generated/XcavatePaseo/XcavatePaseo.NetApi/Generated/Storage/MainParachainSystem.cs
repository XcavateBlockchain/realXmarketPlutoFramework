...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        public ParachainSystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastHrmpMqcHeads"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(XcavatePaseo.NetApi.Generated.Types.Base.BTreeMapT6)));
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Types.Base.BTreeMapT6> LastHrmpMqcHeads(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastHrmpMqcHeadsParams();
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Types.Base.BTreeMapT6>(parameters, blockhash, token);
            return result;
        }
