...
public partial class XcavateRoleBadgeView : ContentView
{
    ...
    public static readonly BindableProperty RoleProperty = BindableProperty.Create(
        ...
        propertyChanged: (bindable, oldValue, newValue) =>
        {
            ...
            control.UpdateRole((XcavateRole)newValue);
        });
    ...
    protected override void OnBindingContextChanged()
    {
        ...
        if (BindingContext is XcavateRole role)
        {
            if (!Equals(Role, role))
            {
                Role = role;
    ...
    private void UpdateRole(XcavateRole role)
    {
        ...
        switch (role)
        {
            case XcavateRole.RealEstateDeveloper:
                border.BackgroundColor = Color.FromArgb("#1A457461");
                roleLabel.TextColor = Color.FromArgb("#457461");
                break;
            case XcavateRole.RealEstateInvestor:
                border.BackgroundColor = Color.FromArgb("#1ADC7DA6");
                roleLabel.TextColor = Color.FromArgb("#DC7DA6");
                break;
            case XcavateRole.LettingAgent:
                border.BackgroundColor = Color.FromArgb("#1A9678AE");
                roleLabel.TextColor = Color.FromArgb("#9678AE");
                break;
            case XcavateRole.Lawyer:
                border.BackgroundColor = Color.FromArgb("#1A4E7DDC");
                roleLabel.TextColor = Color.FromArgb("#4E7DDC");
                break;
            default:
                border.BackgroundColor = Color.FromArgb("#1A888888");
                roleLabel.TextColor = Color.FromArgb("#888888");
                break;
        }
    }
}
